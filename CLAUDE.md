...
2. Read the PRD at `prd.json` (in the current working directory)
3. Read the progress log at `progress.txt` (in the current working directory, check Codebase Patterns section first)
